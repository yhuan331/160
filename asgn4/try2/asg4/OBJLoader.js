...
// OBJParser
//------------------------------------------------------------------------------
console.log("✅ OBJLoader.js loaded");
...
class LoaderUtils {
    ...
    static onReadMTLFile(fileString, mtl) {
        ...
        let textureMapStatements = new Set(["map_Ka", "map_Kd", "map_Ks", "map_Ns", "map_d", "disp", "decal", "bump"]);
            ...
            switch (command) {
                ...
                default:
                    if (textureMapStatements.has(command)) {
                        console.warn(`Warning: This OBJ file specifies the use of texture maps, which are unsupported by this loader. Parts, or even all of this model might not appear correctly. `)
                    }
            }
        }
        mtl.complete = true;
